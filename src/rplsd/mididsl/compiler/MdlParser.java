...
public class MdlParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'o'", "'p'", "'\n'", "'t'", "'v'", "'#include'", "'#track'", 
		"'#section'", "'['", "']'", "'('", "')'", "'#percussion'", "'l'", "NUM", 
		"WS", "ID", "COMMENT", "'+'", "'-'", "'.'", "OCTAVE_SHIFT", "BASE_NOTE", 
		"STRING", "'>'", "'<'"
	};
	public static final int
		...
		RULE_playback = 20, RULE_section = 21, RULE_harmony = 22, RULE_loop = 23;
	public static final String[] ruleNames = {
		...
		"volume", "pitch_transpose", "playback", "section", "harmony", "loop"
	};
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case T__7:
				{
				setState(71); track_declaration();
				}
				break;
			case T__1:
				{
				setState(72); percussion_declaration();
				}
				break;
			case T__8:
				{
			...
			case T__6:
				{
				setState(74); section_declaration();
				}
				break;
			case ID:
				{
	...
	public final Track_declarationContext track_declaration() throws RecognitionException {
		...
		try {
			...
			setState(81); ((Track_declarationContext)_localctx).name = match(ID);
			setState(82); ((Track_declarationContext)_localctx).instrument = match(NUM);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Percussion_declarationContext percussion_declaration() throws RecognitionException {
		...
		try {
			...
			setState(85); ((Percussion_declarationContext)_localctx).name = match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Section_declarationContext section_declaration() throws RecognitionException {
		...
		try {
			...
			setState(88); ((Section_declarationContext)_localctx).name = match(ID);
			setState(90); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__13) | (1L << T__12) | (1L << T__10) | (1L << T__9) | (1L << T__5) | (1L << T__3) | (1L << T__0) | (1L << ID) | (1L << BASE_NOTE))) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final TrackContext track() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(94); ((TrackContext)_localctx).track_name = match(ID);
			setState(96); 
			_errHandler.sync(this);
			_la = _input.LA(1);
			do {
	...
	public final IncludeContext include() throws RecognitionException {
		...
		try {
			...
			setState(101); ((IncludeContext)_localctx).filename = match(STRING);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final NoteContext note() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(108); ((NoteContext)_localctx).base = match(BASE_NOTE);
			setState(110);
			_la = _input.LA(1);
			if (_la==PLUS || _la==MINUS) {
				{
				setState(109); ((NoteContext)_localctx).pitch_shift = pitch_shift_sign();
				}
			}
			...
			if (_la==OCTAVE_SHIFT) {
				{
				setState(112); ((NoteContext)_localctx).octave_shift = match(OCTAVE_SHIFT);
				}
			}
			...
			if (_la==NUM) {
				{
				setState(115); ((NoteContext)_localctx).note_length = match(NUM);
				}
			}
			...
			if (_la==DOT) {
				{
				setState(118); ((NoteContext)_localctx).length_shift = length_shift_sign();
				}
			}
	...
	public final TempoContext tempo() throws RecognitionException {
		...
		try {
			...
			setState(146); ((TempoContext)_localctx).value = match(NUM);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final LengthContext length() throws RecognitionException {
		...
		try {
			...
			setState(149); ((LengthContext)_localctx).value = match(NUM);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final OctaveContext octave() throws RecognitionException {
		...
		try {
			...
			case DOWN:
				{
				setState(154); ((OctaveContext)_localctx).shift = shift_sign();
				setState(156);
				_la = _input.LA(1);
				if (_la==NUM) {
					{
					setState(155); ((OctaveContext)_localctx).value = match(NUM);
					}
				}
			...
			case NUM:
				{
				setState(158); ((OctaveContext)_localctx).value = match(NUM);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final VolumeContext volume() throws RecognitionException {
		...
		try {
			...
			case DOWN:
				{
				setState(162); ((VolumeContext)_localctx).shift = shift_sign();
				setState(164);
				_la = _input.LA(1);
				if (_la==NUM) {
					{
					setState(163); ((VolumeContext)_localctx).value = match(NUM);
					}
				}
			...
			case NUM:
				{
				setState(166); ((VolumeContext)_localctx).value = match(NUM);
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public final Pitch_transposeContext pitch_transpose() throws RecognitionException {
		...
		try {
			...
			case DOWN:
				{
				setState(170); ((Pitch_transposeContext)_localctx).shift = shift_sign();
				setState(172);
				_la = _input.LA(1);
				if (_la==NUM) {
					{
			...
			case MINUS:
				...
				if (_la==MINUS) {
					{
					setState(174); ((Pitch_transposeContext)_localctx).negative = match(MINUS);
					}
				}

				setState(177); ((Pitch_transposeContext)_localctx).value = match(NUM);
				}
				}
				break;
			default:
	...
	public final SectionContext section() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(185); ((SectionContext)_localctx).name = match(ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		"\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\34\u00cf\4\2\t\2"+
		"\4\3\t\3\4\4\t\4\4\5\t\5\4\6\t\6\4\7\t\7\4\b\t\b\4\t\t\t\4\n\t\n\4\13"+
		"\t\13\4\f\t\f\4\r\t\r\4\16\t\16\4\17\t\17\4\20\t\20\4\21\t\21\4\22\t\22"+
		"\4\23\t\23\4\24\t\24\4\25\t\25\4\26\t\26\4\27\t\27\4\30\t\30\4\31\t\31"+
		"\3\2\3\2\3\3\6\3\66\n\3\r\3\16\3\67\3\3\3\3\5\3<\n\3\3\4\7\4?\n\4\f\4"+
		"\16\4B\13\4\3\4\7\4E\n\4\f\4\16\4H\13\4\3\5\3\5\3\5\3\5\3\5\5\5O\n\5\3"+
		"\5\3\5\3\6\3\6\3\6\3\6\3\7\3\7\3\7\3\b\3\b\3\b\6\b]\n\b\r\b\16\b^\3\t"+
		"\3\t\6\tc\n\t\r\t\16\td\3\n\3\n\3\n\3\13\3\13\3\13\5\13m\n\13\3\f\3\f"+
		"\5\fq\n\f\3\f\5\ft\n\f\3\f\5\fw\n\f\3\f\5\fz\n\f\3\r\6\r}\n\r\r\r\16\r"+
		"~\3\r\6\r\u0082\n\r\r\r\16\r\u0083\5\r\u0086\n\r\3\16\6\16\u0089\n\16"+
		"\r\16\16\16\u008a\3\17\3\17\3\17\3\17\3\17\5\17\u0092\n\17\3\20\3\20\3"+
		"\20\3\21\3\21\3\21\3\22\3\22\3\23\3\23\3\23\5\23\u009f\n\23\3\23\5\23"+
		"\u00a2\n\23\3\24\3\24\3\24\5\24\u00a7\n\24\3\24\5\24\u00aa\n\24\3\25\3"+
		"\25\3\25\5\25\u00af\n\25\3\25\5\25\u00b2\n\25\3\25\5\25\u00b5\n\25\3\26"+
		"\3\26\3\26\5\26\u00ba\n\26\3\27\3\27\3\30\3\30\6\30\u00c0\n\30\r\30\16"+
		"\30\u00c1\3\30\3\30\3\31\3\31\6\31\u00c8\n\31\r\31\16\31\u00c9\3\31\3"+
		"\31\3\31\3\31\2\2\32\2\4\6\b\n\f\16\20\22\24\26\30\32\34\36 \"$&(*,.\